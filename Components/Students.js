...
import { View, Text, TouchableOpacity, ActivityIndicator, ScrollView, ImageBackground, Image, Modal, Animated, StatusBar } from 'react-native';
    ...
    return (
        <>
            ...
            <ScrollView className="bg-gray-100">
                <View className="w-screen bg-custom-blue h-[70px] flex-row justify-between items-center px-2">
                ...
                <View className="px-2">
                    {instructorName ? (
                        ...
                        <Text className="text-3xl font-bold text-gray-100 mt-5">
                            <Text className="text-2xl text-gray-100">Hi,</Text> {instructorName}
                        </Text>
                    }
